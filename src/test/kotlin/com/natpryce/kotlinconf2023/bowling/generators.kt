...
fun Arb.Companion.playerCount() = int(1..10)

fun Arb.Companion.bowlingGame() = playerCount().map(::newGame)

fun Arb.Companion.roll(pinsDown: Int = 0, maxPins: Int = 10) = Arb.int(0..(maxPins - pinsDown))
